...
-- Usar variables para los IDs de las categorías padre
SET @id_ropa_femenina = (SELECT id FROM categorias WHERE nombre_categoria = 'Ropa Femenina');
SET @id_ropa_masculina = (SELECT id FROM categorias WHERE nombre_categoria = 'Ropa Masculina');

INSERT INTO categorias (nombre_categoria, descripcion, categoria_padre_id, nivel, orden_visualizacion) VALUES
('Blusas', 'Blusas y camisas femeninas', @id_ropa_femenina, 2, 1),
('Pantalones', 'Pantalones y jeans femeninos', @id_ropa_femenina, 2, 2),
('Vestidos', 'Vestidos casuales y elegantes', @id_ropa_femenina, 2, 3),
('Camisas', 'Camisas masculinas', @id_ropa_masculina, 2, 1),
('Pantalones Hombre', 'Pantalones y jeans masculinos', @id_ropa_masculina, 2, 2);
